...
public class Registro038 {
	...
	public String conta;
	public String numeroRvOriginal;
	public String dataRvoriginal;
	public String valorCreditoOriginal;
	public String motivoDebito;
	public String motivoDebitoString;
	public String numeroCartao;
	public String numReferenciaCartaFax;
	public String mesDeReferencia;
	...
	public String getMotivoDebitoString() {
		return motivoDebitoString;
	}
	public void setMotivoDebitoString(String motivoDebitoString) {
		this.motivoDebitoString = motivoDebitoString;
	}
	...
	public String getNumResumoDebito() {
		return numResumoDebito;
	}
	public void setNumResumoDebito(String numResumoDebito) {
		this.numResumoDebito = numResumoDebito;
	}
