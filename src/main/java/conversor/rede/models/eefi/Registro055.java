...
public class Registro055 {

	public String tipoRegistro;
	public String numCartao;
	public String numNsu;
	public String dataCvOriginalDaTransacao;
	...
	public String getDataCvOriginalDaTransacao() {
		return dataCvOriginalDaTransacao;
	}
	public void setDataCvOriginalDaTransacao(String dataCvOriginalDaTransacao) {
		this.dataCvOriginalDaTransacao = dataCvOriginalDaTransacao;
	}
